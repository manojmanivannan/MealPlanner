...
try:
    from db.alembic.models import Base
except ModuleNotFoundError:
    from backend.db.alembic.models import Base
...
def run_migrations_online() -> None:
    ...
    """
    # COMMENT OUT or DELETE this original block which causes the error
    ...
    # ADD THIS NEW LINE to create the engine from our dynamic URL
    connectable = create_engine(config.get_main_option("sqlalchemy.url",db_url))
